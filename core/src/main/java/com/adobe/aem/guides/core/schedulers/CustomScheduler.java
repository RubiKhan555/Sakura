...
import com.adobe.aem.guides.core.schedulers.SlingSchedulerConf;
...
@Designate(ocd = SlingSchedulerConf.class)
public class CustomScheduler implements Runnable {
	 ...
	 */
	@Activate
	protected void activate(SlingSchedulerConf config) {
	 ...
	 */
	@Modified
	protected void modified(SlingSchedulerConf config) {
	 ...
	 */
	@Deactivate
	protected void deactivate(SlingSchedulerConf config) {
	 ...
	 * @param config
	 */
	private void addScheduler(SlingSchedulerConf config) {
